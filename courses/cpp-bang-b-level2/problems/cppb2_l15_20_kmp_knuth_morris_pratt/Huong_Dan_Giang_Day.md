# Hướng Dẫn Giảng Dạy: KMP KNUTH MORRIS PRATT
Chuyên đề: **Xử Lý Chuỗi, String Hashing & BigInt**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: **KMP KNUTH MORRIS PRATT** thuộc chuyên đề Xử Lý Chuỗi, String Hashing & BigInt.
...
* **Bản chất bài toán:** Trong lập trình thi đấu chuyên nghiệp, bài toán **Kmp Knuth Morris Pratt** là một dạng bài điển hình thuộc chuyên đề **Xử Lý Chuỗi, String Hashing & BigInt**. Bài toán yêu cầu thiết kế thuật toán tối ưu để xử lý tập dữ liệu lớn trong giới hạn thời gian nghiêm ngặt $1.0\text{s}$.
