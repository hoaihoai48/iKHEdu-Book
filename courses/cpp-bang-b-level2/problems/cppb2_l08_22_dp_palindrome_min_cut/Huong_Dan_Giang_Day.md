# Hướng Dẫn Giảng Dạy: Cắt chuỗi thành ít chuỗi đối xứng nhất (Palindrome Partitioning)
Chuyên đề: **Quy Hoạch Động Cơ Bản & Chuyên Sâu (Dynamic Programming)**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ phương pháp giải quyết bài toán bằng kỹ thuật thuộc chuyên đề Quy Hoạch Động Cơ Bản & Chuyên Sâu (Dynamic Programming).
