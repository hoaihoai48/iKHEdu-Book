# Hướng Dẫn Giảng Dạy: Số nhỏ nhất thu được sau tối đa K lần đổi chỗ kề nhau
Chuyên đề: **Thuật Toán Tham Lam (Greedy Algorithms)**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ phương pháp giải quyết bài toán bằng kỹ thuật thuộc chuyên đề Thuật Toán Tham Lam (Greedy Algorithms).
