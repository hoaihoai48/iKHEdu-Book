# Hướng Dẫn Giảng Dạy: NGUYEN LY BAO HAM LOAI TRU PIE
Chuyên đề: **Tổ Hợp, Hoán Vị & Xác Suất Cơ Bản (Combinatorics)**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: **NGUYEN LY BAO HAM LOAI TRU PIE** thuộc chuyên đề Tổ Hợp, Hoán Vị & Xác Suất Cơ Bản (Combinatorics).
...
* **Bản chất bài toán:** Trong lập trình thi đấu chuyên nghiệp, bài toán **Nguyen Ly Bao Ham Loai Tru Pie** là một dạng bài điển hình thuộc chuyên đề **Tổ Hợp, Hoán Vị & Xác Suất Cơ Bản (Combinatorics)**. Bài toán yêu cầu thiết kế thuật toán tối ưu để xử lý tập dữ liệu lớn trong giới hạn thời gian nghiêm ngặt $1.0\text{s}$.
