# Hướng Dẫn Giảng Dạy: Priority Queue với Custom Struct giải bài toán đồ thị nhiều chiều
Chuyên đề: **Thư Viện STL C++ Nâng Cao (Advanced STL Containers)**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ phương pháp giải quyết bài toán bằng kỹ thuật thuộc chuyên đề Thư Viện STL C++ Nâng Cao (Advanced STL Containers).
