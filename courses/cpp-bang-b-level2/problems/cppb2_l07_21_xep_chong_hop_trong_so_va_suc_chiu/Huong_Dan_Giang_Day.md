# Hướng Dẫn Giảng Dạy: XEP CHONG HOP TRONG SO VA SUC CHIU
Chuyên đề: **Thuật Toán Tham Lam (Greedy Algorithms)**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: **XEP CHONG HOP TRONG SO VA SUC CHIU** thuộc chuyên đề Thuật Toán Tham Lam (Greedy Algorithms).
...
* **Bản chất bài toán:** Trong lập trình thi đấu chuyên nghiệp, bài toán **Xep Chong Hop Trong So Va Suc Chiu** là một dạng bài điển hình thuộc chuyên đề **Thuật Toán Tham Lam (Greedy Algorithms)**. Bài toán yêu cầu thiết kế thuật toán tối ưu để xử lý tập dữ liệu lớn trong giới hạn thời gian nghiêm ngặt $1.0\text{s}$.
