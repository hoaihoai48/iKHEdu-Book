# Hướng dẫn giảng dạy: Diện tích hợp các hình chữ nhật

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Làm chủ giải thuật và kỹ thuật lập trình tối ưu cho bài toán **Diện Tích Hợp Các Hình Chữ Nhật**.
