# Hướng Dẫn Giảng Dạy: Quét đường (Sweep-line) diện tích hợp các hình chữ nhật
Chuyên đề: **Kỹ Thuật Mảng: Two Pointers, Window & 2D Prefix Sum**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ phương pháp giải quyết bài toán bằng kỹ thuật thuộc chuyên đề Kỹ Thuật Mảng: Two Pointers, Window & 2D Prefix Sum.
