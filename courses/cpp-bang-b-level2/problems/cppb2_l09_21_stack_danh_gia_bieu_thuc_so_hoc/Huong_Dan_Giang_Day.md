# Hướng Dẫn Giảng Dạy: STACK DANH GIA BIEU THUC SO HOC
Chuyên đề: **Ngăn Xếp & Deque Đơn Điệu (Monotonic Stack & Deque)**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: **STACK DANH GIA BIEU THUC SO HOC** thuộc chuyên đề Ngăn Xếp & Deque Đơn Điệu (Monotonic Stack & Deque).
...
* **Bản chất bài toán:** Trong lập trình thi đấu chuyên nghiệp, bài toán **Stack Danh Gia Bieu Thuc So Hoc** là một dạng bài điển hình thuộc chuyên đề **Ngăn Xếp & Deque Đơn Điệu (Monotonic Stack & Deque)**. Bài toán yêu cầu thiết kế thuật toán tối ưu để xử lý tập dữ liệu lớn trong giới hạn thời gian nghiêm ngặt $1.0\text{s}$.
