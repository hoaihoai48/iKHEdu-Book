...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: **NGHIỆM NGUYÊN DƯƠNG NHỎ NHẤT CỦA PHƯƠNG TRÌNH DIOPHANTINE** thuộc chuyên đề Số Học Cơ Bản & Chuyên Sâu (Number Theory).
