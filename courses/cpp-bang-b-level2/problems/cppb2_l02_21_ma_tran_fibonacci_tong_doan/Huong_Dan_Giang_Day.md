# Hướng dẫn giảng dạy: Ma tran fibonacci tong doan

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Làm chủ giải thuật và kỹ thuật lập trình tối ưu cho bài toán **Ma Tran Fibonacci Tong Doan**.
