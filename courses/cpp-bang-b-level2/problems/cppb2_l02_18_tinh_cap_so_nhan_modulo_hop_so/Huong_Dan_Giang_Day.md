# Hướng Dẫn Giảng Dạy: TINH CAP SO NHAN MODULO HOP SO
Chuyên đề: **Đại Số Đồng Dư & Lũy Thừa Nhanh (Modular Arithmetic)**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: **TINH CAP SO NHAN MODULO HOP SO** thuộc chuyên đề Đại Số Đồng Dư & Lũy Thừa Nhanh (Modular Arithmetic).
...
* **Bản chất bài toán:** Trong lập trình thi đấu chuyên nghiệp, bài toán **Tinh Cap So Nhan Modulo Hop So** là một dạng bài điển hình thuộc chuyên đề **Đại Số Đồng Dư & Lũy Thừa Nhanh (Modular Arithmetic)**. Bài toán yêu cầu thiết kế thuật toán tối ưu để xử lý tập dữ liệu lớn trong giới hạn thời gian nghiêm ngặt $1.0\text{s}$.
