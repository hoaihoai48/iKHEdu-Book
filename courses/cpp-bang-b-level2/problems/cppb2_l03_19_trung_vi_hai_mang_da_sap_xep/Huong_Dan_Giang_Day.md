# Hướng Dẫn Giảng Dạy: TRUNG VI HAI MANG DA SAP XEP
Chuyên đề: **Tìm Kiếm Nhị Phân Nâng Cao (Binary Search)**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: **TRUNG VI HAI MANG DA SAP XEP** thuộc chuyên đề Tìm Kiếm Nhị Phân Nâng Cao (Binary Search).
...
* **Bản chất bài toán:** Trong lập trình thi đấu chuyên nghiệp, bài toán **Trung Vi Hai Mang Da Sap Xep** là một dạng bài điển hình thuộc chuyên đề **Tìm Kiếm Nhị Phân Nâng Cao (Binary Search)**. Bài toán yêu cầu thiết kế thuật toán tối ưu để xử lý tập dữ liệu lớn trong giới hạn thời gian nghiêm ngặt $1.0\text{s}$.
