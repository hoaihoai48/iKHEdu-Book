# Hướng Dẫn Giảng Dạy: Hình chữ nhật lớn nhất trong biểu đồ cột (Largest Rectangle in Histogram)
Chuyên đề: **Ngăn Xếp & Deque Đơn Điệu (Monotonic Stack & Deque)**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ phương pháp giải quyết bài toán bằng kỹ thuật thuộc chuyên đề Ngăn Xếp & Deque Đơn Điệu (Monotonic Stack & Deque).
