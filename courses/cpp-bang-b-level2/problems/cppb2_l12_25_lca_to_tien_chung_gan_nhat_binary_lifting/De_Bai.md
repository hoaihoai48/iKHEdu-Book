# Tổ tiên chung gần nhất (binary lifting)

## Bối cảnh

Bảo tàng lịch sử dòng họ số hoá cây phả hệ gồm N thành viên với quan hệ cha con rõ ràng tạo thành một cây có gốc là cụ tổ. Mỗi ngày hệ thống đón hàng nghìn lượt tra cứu tìm cụ chung gần nhất của hai thành viên để xác định vai vế trong họ tộc phục vụ việc xếp cỗ ngày giỗ tổ. Hệ thống tiền xử lý bảng nhảy nhị phân để trả lời mỗi truy vấn gần như tức thì.
