# Hướng dẫn giảng dạy: Tam giác có diện tích lớn nhất

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Làm chủ giải thuật và kỹ thuật lập trình tối ưu cho bài toán **Tam Giác Có Diện Tích Lớn Nhất**.
