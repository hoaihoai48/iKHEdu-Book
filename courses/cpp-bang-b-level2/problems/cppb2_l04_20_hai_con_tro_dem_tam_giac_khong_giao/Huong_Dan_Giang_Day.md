# Hướng dẫn giảng dạy: Đếm số bộ ba tam giác hợp lệ

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Làm chủ giải thuật và kỹ thuật lập trình tối ưu cho bài toán **Đếm Số Bộ Ba Tam Giác Hợp Lệ**.
