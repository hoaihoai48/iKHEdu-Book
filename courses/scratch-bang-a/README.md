...
> **Trang chủ quản trị khóa học**: Khóa học lập trình khối lệnh Scratch dành cho học sinh Tiểu học (8–11 tuổi), chuẩn bị nền tảng vững chắc cho kỳ thi **Tin học trẻ Bảng A**, gồm **6 Chương — 16 Bài học chuyên sâu**, kho **324 Bài tập thực hành thật** và hệ thống hình ảnh trực quan 100%.
...
| **Quy chuẩn bài tập** | **100% Bài tập thật (Zero Dummy / Zero Placeholder)**: 37 bài đồ họa Pen + 287 bài toán thuật toán Tin học trẻ có nguồn trace 1-1 về Python Bảng A |
...
- `problems/`: Chứa 324 thư mục bài tập độc lập theo chuẩn iKHEDU (`De_Bai.md`, `Huong_Dan_Giang_Day.md`, `solution.dsl`, `interaction-check.json`).
