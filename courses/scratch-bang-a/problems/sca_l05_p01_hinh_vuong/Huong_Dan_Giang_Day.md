...
- Quy trình trong lời giải: đọc biến `a` bằng `câu trả lời`, rồi in `4 * a` và `a * a` trên cùng một dòng; với mẫu `a = 6` thì chu vi `4 * 6 = 24` và diện tích `6 * 6 = 36`.
...
|---|---|---|---|
| 1 | Đọc `a = câu trả lời` | `a = 6` | cạnh bằng 6 |
...
- Bẫy 3 — quên đổi kiểu: viết `a = câu trả lời` thì `4 * a` với mẫu lặp chuỗi cho ra kết quả lạ thay vì `24 36`; cách sửa là bọc `câu trả lời`.
