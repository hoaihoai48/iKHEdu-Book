...
- *Độ phức tạp:* **Thời gian:** $8 \text{ cánh} \times 2 \text{ cung} \times 90 \text{ bước} = 1440$ phép di chuyển và quay vi phân. Khuyến khích tích chọn *"Chạy không làm mới màn hình"* trên My Blocks để đóa hoa nở rộ tức thì. **Không gian:** $\mathcal{O}(1)$ bộ nhớ RAM.
...
![Khối lệnh Scratch 3.0 giải bài sca_pen_p14_bong_hoa_8_canh](solution_blocks_vi.png)
