...
- Xử lý biên: với N nhỏ nhất là 1 thì `1 * làm tròn xuống của (2 / 2) = 1`; với N lớn nhất là 100 000 thì `100000 * làm tròn xuống của (100001 / 2) = 5000050000`.
...
|---|---|---|---|
| 1 | 4 | 4 * làm tròn xuống của (5 / 2) | 10 |
