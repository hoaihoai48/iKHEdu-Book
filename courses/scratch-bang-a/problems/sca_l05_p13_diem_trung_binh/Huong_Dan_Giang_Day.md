...
- Bẫy 3 — in thô không làm tròn: viết `nói ((d1 + d2 + d3) / 3)` thì với mẫu ra `8.333333333333334` thay vì `8.33`; cách sửa là ghi định dạng 2 chữ số thập phân.
