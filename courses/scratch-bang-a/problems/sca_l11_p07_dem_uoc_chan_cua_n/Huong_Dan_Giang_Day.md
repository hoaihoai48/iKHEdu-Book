# Hướng Dẫn Giảng Dạy: Đếm ước chẵn của N
Chuyên đề: **Lập Trình Thuật Toán & Khối Lệnh Scratch 3.0**

---

## 1. Ý tưởng & Phân tích thuật toán
- Bản chất của bài này: với `n = 12`, vừa kiểm tra `12 % i == 0` vừa kiểm tra `i % 2 == 0`, cả hai điều kiện đúng mới đếm.
...
if n % i == 0:
    dem = dem + 1
```
với mẫu `12` sẽ đếm cả `1, 3` và in ra `6`, là kết quả sai. Sửa lại: `if n % i == 0 and i % 2 == 0`.
- Bẫy 2: kiểm tra `n % 2 == 0` thay vì `i % 2 == 0`. Với mẫu `12` thì `12` là số chẵn nên đếm cả 6 ước và in `6`. Sửa lại: kiểm tra từng `i`, tức `i % 2 == 0`.
