...
- Quy trình trong lời giải: đọc biến `d` bằng `câu trả lời`, rồi tính `d * 25000` và in ra; với mẫu `d = 4` thì `4 * 25000 = 100000`.
...
|---|---|---|---|
| 1 | Đọc `d = câu trả lời` | `d = 4` | nhận 4 đô la |
...
- Bẫy 2 — quên đổi chữ thành số: viết `d = câu trả lời` rồi `nói (d * 25000)` thì với mẫu sẽ lặp chuỗi cho ra một dãy rất dài thay vì `100000`; cách sửa là bọc `câu trả lời`.
