...
- Quy trình gồm ba bước với hai biến `a` và `b` trong lời giải: đọc `7` vào `a` và `9` vào `b` bằng `int(hỏi và đợi)`, rồi tính `a * b` tức `63` và dùng chuỗi `f"{a} x {b} = {a * b}"` để đặt ba con số vào đúng vị trí trong khung.
...
|------|-----------|--------------|------------------|
| 1 | `a = int(hỏi và đợi)` với dòng 1 gõ `7` | `a = 7` | (chưa in gì) |
| 2 | `b = int(hỏi và đợi)` với dòng 2 gõ `9` | `b = 9` | (chưa in gì) |
| 3 | `nói (f"{a} x {b} = {a * b}")` tức ghép `7`, `9`, `63` vào khung | `a = 7`, `b = 9` | `7 x 9 = 63` |
| 4 | Kết thúc chương trình | — | Kết quả cuối cùng: `7 x 9 = 63`. |

---

## 3. Lưu ý & Bẫy lỗi thường gặp
- Bẫy 1: chỉ in kết quả `nói (a * b)` thì với mẫu `7` và `9` màn hình hiện `63` thay vì `7 x 9 = 63`. Cách sửa: in cả khung bằng `nói (f"{a} x {b} = {a * b}")`.
