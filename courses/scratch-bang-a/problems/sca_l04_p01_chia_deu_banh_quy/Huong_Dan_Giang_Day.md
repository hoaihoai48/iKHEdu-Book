...
- Bản chất là phép chia nguyên một lần: với `a = 17` chiếc bánh và `b = 5` chiếc đĩa, số bánh mỗi đĩa là `làm tròn xuống của (a / b) = làm tròn xuống của (17 / 5) = 3`, số dư là `(a mod b) = (17 mod 5) = 2`.
- Quy trình trong lời giải: đọc `a` từ dòng 1, đọc `b` từ dòng 2, rồi in một dòng duy nhất `nói (làm tròn xuống của (a / b), (a mod b))` cho ra `3 2`.
...
| 3 | Tính `làm tròn xuống của (a / b)` | `làm tròn xuống của (17 / 5) = 3` |
| 4 | Tính `(a mod b)` | `(17 mod 5) = 2` |
...
Cách sửa: in cả hai giá trị `nói (làm tròn xuống của (a / b), (a mod b))`.
