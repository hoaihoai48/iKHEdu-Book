...
- Quy trình trong lời giải với biến `n`:
  ...
  - Áp dụng công thức ghép cặp: `n * (n + 1) // 2`, với mẫu là `5 * làm tròn xuống của (6 / 2) = làm tròn xuống của (30 / 2) = 15`.
  - In ra `15`.
...
|------|----------|---------|
| 1 | Đọc `n = câu trả lời` | `n = 5` |
| 2 | Tính `n + 1` | `6` |
| 3 | Tính `n * (n + 1)` | `5 * 6 = 30` |
| 4 | Chia nguyên `làm tròn xuống của (30 / 2)` | `15` |
...
```
Với mẫu `5`, `n` là chuỗi nên `n + 1` gây lỗi chương trình. Cách sửa: đọc bằng `n = câu trả lời`.
