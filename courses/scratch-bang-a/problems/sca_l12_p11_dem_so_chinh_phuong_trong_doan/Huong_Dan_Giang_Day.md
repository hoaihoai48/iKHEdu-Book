...
- Bẫy 3: quên trường hợp `j < i` (đoạn không chứa số chính phương nào). Khi đó `j - i + 1` ra số âm, là kết quả sai. Sửa lại: giữ nhánh `if j < i: print(0)` như bài giải.
