...
- Quy trình từng bước với đúng tên biến trong lời giải:
  - Bước 1: `n = int(câu trả lời)` đọc số. Với mẫu, `n = 2024`.
  - Bước 2: đặt `tong = 0`.
  - Bước 3: lặp `while n > 0`, mỗi lần cộng `n % 10` vào `tong` rồi gọt `n = n // 10`.
  - Bước 4: in `tong`.
...
- Bẫy 1: quên gọt `n` trong vòng lặp, `n` mãi bằng 2024 nên lặp vô tận. Cách sửa: cuối mỗi lần lặp phải `n = n // 10`.
```text
n = int(câu trả lời)
tong = 0
while n > 0:
