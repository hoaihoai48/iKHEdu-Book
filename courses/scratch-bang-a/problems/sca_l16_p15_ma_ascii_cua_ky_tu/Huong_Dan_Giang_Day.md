...
- Quy trình:
  - Đọc ký tự vào biến `ch`. Với số liệu mẫu, sau `câu trả lời`, `ch = "A"`.
...
|---|---|---|---|
| 1 | `ch = câu trả lời` | `ch = "A"` | ký tự mẫu |
...
```
Nếu nhập `A` kèm dấu cách ở đầu, máy đọc nhầm dấu cách (mã 32) và in ra `32`, đáp án đúng là `65`. Cách sửa: đọc `ch = câu trả lời`.
