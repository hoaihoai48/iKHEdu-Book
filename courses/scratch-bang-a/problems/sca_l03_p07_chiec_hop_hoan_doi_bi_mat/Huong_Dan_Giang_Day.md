...
- Quy trình gồm ba bước với hai biến `a` và `b` trong lời giải: đọc `7` vào `a` và `12` vào `b` bằng `câu trả lời`, đổi chỗ cùng lúc bằng `a, b = b, a`, rồi `nói (a, b)` in ra `12 7`.
...
|------|-----------|--------------|------------------|
| 1 | `a = câu trả lời` với dòng 1 gõ `7` | `a = 7` | (chưa in gì) |
| 2 | `b = câu trả lời` với dòng 2 gõ `12` | `b = 12` | (chưa in gì) |
