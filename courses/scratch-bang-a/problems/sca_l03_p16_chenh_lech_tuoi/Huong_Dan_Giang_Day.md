...
- Bẫy 1: chỉ in hiệu `nói (a - e)` thì với mẫu `12 7` màn hình hiện `5` thay vì `Anh hon em 5 tuoi.` nên bị tính là kết quả sai. Cách sửa: in cả câu bằng `nói (f"Anh hon em {a - e} tuoi.")`.
