# Hướng Dẫn Giảng Dạy: Hai số nguyên tố cùng nhau
...
- Với `a = 8`, `b = 9`, chương trình đặt `x = 8`, `y = 9` rồi lặp `x, y = y, x % y` tới khi `y == 0`; `x` còn lại chính là ước chung lớn nhất.
...
| 1 | 9 | 8 | 1 | `8 % 9 = 8`, gán tiếp |
| 2 | 8 | 1 | 0 | `9 % 8 = 1`, gán tiếp |
