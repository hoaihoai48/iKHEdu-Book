...
- Quy trình trong lời giải: đọc `n = câu trả lời`, rồi tính `n * (n + 1) // 2` và in ra. Dấu `//` là chia lấy phần nguyên, giữ kết quả luôn là số nguyên.
- Xử lý biên: với N nhỏ nhất là 1 thì `1 * làm tròn xuống của (2 / 2) = 1`; với N lớn nhất 1 000 000 000 thì `1000000000 * làm tròn xuống của (1000000001 / 2) = 500000000500000000`, Python tính số nguyên lớn chính xác.
...
|---|---|---|---|
| 1 | 1000000000 | 1000000000 * làm tròn xuống của (1000000001 / 2) | 500000000500000000 |
...
```
Với mẫu `1000000000` chương trình lặp 1 tỉ lần nên chạy quá thời gian quy định, không ra kết quả kịp. Cách sửa: thay cả vòng lặp bằng `nói (n * (n + 1) // 2)`.
