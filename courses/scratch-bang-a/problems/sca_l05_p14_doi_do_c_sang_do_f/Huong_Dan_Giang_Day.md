...
- Quy trình trong lời giải: đọc biến `c` bằng `int(câu trả lời)`, rồi in `c * 9 // 5 + 32`; với mẫu `c = 30` thì `30 * 9 = 270`, `270 // 5 = 54`, `54 + 32 = 86`.
...
|---|---|---|---|
| 1 | Đọc `c = int(câu trả lời)` | `c = 30` | 30 độ C |
...
- Bẫy 3 — quên cộng 32: viết `nói (c * 9 // 5)` thì với mẫu ra `54` thay vì `86`; cách sửa là cộng thêm 32.
