...
- Quy trình từng bước với đúng tên biến trong lời giải:
  - Bước 1: `n = câu trả lời` đọc số. Với mẫu, `n = 1379`.
  - Bước 2: gọt từng chữ số bằng `digits.append((n mod 10))` rồi đảo lại `digits = digits[::-1]` để được thứ tự từ trái sang phải. Với mẫu, `digits = [1, 3, 7, 9]`.
...
> - xóa tất cả của [digits]
> - lặp lại cho đến khi <n = 0>:
> -   thêm (n mod 10) vào [digits]
> -   đặt [n] thành (n chia nguyên 10)
> - đặt [digits] thành (giá trị)
> - đặt [tang] thành (all(...))
> - đặt [giam] thành (all(...))
> - nếu <điều kiện> thì:
> -   nói (TANG)
