...
- *Độ phức tạp:* **Thời gian:** $5 \times 360 = 1800$ bước lặp vi phân. Ở chế độ chạy Turbo Mode hoặc My Blocks không làm mới màn hình (Run without screen refresh), chương trình hoàn thành vẽ chỉ trong $0.1$ giây. **Không gian:** $\mathcal{O}(1)$ bộ nhớ RAM, dùng 1 Sprite mặc định.
...
![Khối lệnh Scratch 3.0 giải bài sca_pen_p12_logo_olympic](solution_blocks_vi.png)
