...
- Bản chất của bài này: với `n = 10`, duyệt mọi `i` từ `1` tới `10` và đếm các `i` mà `(10 mod i) == 0`.
...
| `i` | `(10 mod i)` | `dem` sau bước | Ghi chú |
| --- | --- | --- | --- |
| 1 | 0 | 1 | `(10 mod 1) == 0`, đếm |
| 2 | 0 | 2 | `(10 mod 2) == 0`, đếm |
| 3 | 1 | 2 | không đếm |
| 4 | 2 | 2 | không đếm |
| 5 | 0 | 3 | `(10 mod 5) == 0`, đếm |
| 6 | 4 | 3 | không đếm |
| 7 | 3 | 3 | không đếm |
| 8 | 2 | 3 | không đếm |
| 9 | 1 | 3 | không đếm |
| 10 | 0 | 4 | `(10 mod 10) == 0`, đếm |
