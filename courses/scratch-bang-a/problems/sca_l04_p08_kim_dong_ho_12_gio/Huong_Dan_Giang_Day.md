...
- Bản chất là đồng hồ vòng tròn 12 số: với `h = 10`, `k = 5` thì `(10 + 5 - 1) % 12 + 1 = (14 mod 12) + 1 = 2 + 1 = 3`.
...
Với số liệu mẫu trên, đoạn này cho `10` và `5` cho `(15 mod 12) = 3` trùng đáp số nhưng với `7` và `5` cho `0` thay vì `12`.
...
```text
h, k = các khối hỏi và đợi cho từng biến
