...
- Bẫy 2 — in thô không làm tròn: viết `nói ((a * b) / 2)` với cặp số cho kết quả nguyên sẽ thiếu `.0`; cách sửa là luôn ghi định dạng 1 chữ số thập phân.
- Bẫy 3 — đọc hai dòng riêng: dùng hai lần `câu trả lời` thì với mẫu một dòng `5 7` sẽ bị treo chờ; cách sửa là tách một dòng bằng `split()`.
