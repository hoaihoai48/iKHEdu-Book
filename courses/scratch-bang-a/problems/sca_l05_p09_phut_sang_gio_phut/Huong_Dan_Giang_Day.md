...
|---|---|---|---|
| 1 | Đọc `m = int(câu trả lời)` | `m = 135` | 135 phút |
...
- Bẫy 3 — quên ép kiểu: viết `m = câu trả lời` thì `m // 60` bị lỗi vì chuỗi không chia được; cách sửa là `int(câu trả lời)`.
...
> - nói (f"{m  /  60} gio {m  chia lấy dư  60} phut")
