...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: Lũy Thừa Số Lớn Chính Xác (A^B).
...
* **Dữ liệu đầu vào:** - Một dòng duy nhất chứa 2 số nguyên $A, B$ ($1 \le A \le 100, 0 \le B \le 1000$).
* **Yêu cầu cốt lõi:** Cho 2 số nguyên $A, B$. Hãy in ra giá trị chính xác của $A^B$.
