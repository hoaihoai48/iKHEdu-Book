# Hướng Dẫn Giảng Dạy: Tam Giác Số Tổng Lớn Nhất (Triangle DP)
...
- **Bản chất bài toán:** Cho cấu trúc kim tự tháp số $N$ tầng. Hãy lập trình tìm đường đi từ đỉnh xuống đáy sao cho tổng các số trên đường đi là lớn nhất.
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `4 2 3 4 6 5 7 4 1 8 3` $\implies$ Đầu ra kỳ vọng: `21`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `4 2 3 4 6 5 7 4 1 8 3` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với tam giác số gồm 4 tầng: 3 7 4 2 4 6 8 5 9 3 Đường đi mang lại tổng lớn nhất là $3 × o 7 × o 4 × o 9$, cho tổng lớn nhất ... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `21` |

*Giải thích chi tiết:* Với tam giác số gồm 4 tầng:
3
7 4
2 4 6
8 5 9 3
