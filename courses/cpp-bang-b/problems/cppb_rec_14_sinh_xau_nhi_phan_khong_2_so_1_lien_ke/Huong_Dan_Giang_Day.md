...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật: Sinh Xâu Nhị Phân Không Chứa Hai Số 1 Liền Kề.
...
* **Yêu cầu cốt lõi:** Cho số nguyên dương $N$. Hãy sinh tất cả các xâu nhị phân độ dài $N$ theo thứ tự từ điển sao cho không có 2 ký tự `'1'` nào đứng cạnh nhau bằng hàm đệ quy phân nhánh trạng thái.
...
101
```
* **Phân tích thực thi:** Với N = 3, có 5 xâu hợp lệ: 000, 001, 010, 100, 101.
