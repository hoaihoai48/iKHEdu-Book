# Hướng Dẫn Giảng Dạy: Max Mọi Cửa Sổ Trượt Bằng Monotonic Deque O(N)
...
- **Bản chất bài toán:** Cho mảng $A$ gồm $N$ số nguyên và kích thước cửa sổ $K$. Hãy lập trình tìm giá trị lớn nhất trong mỗi cửa sổ trượt kích thước $K$.
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `8 3 1 3 -1 -3 5 3 6 7` $\implies$ Đầu ra kỳ vọng: `3 3 5 5 6 7`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `8 3 1 3 -1 -3 5 3 6 7` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với mảng $[1, 3, -1, -3, 5, 3, 6, 7]$ và $K = 3$: - Cửa sổ [1, 3, -1] -> max = 3. - Cửa sổ [3, -1, -3] -> max = 3. - Cửa sổ [-1, -3, 5]... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `3 3 5 5 6 7` |

*Giải thích chi tiết:* Với mảng $[1, 3, -1, -3, 5, 3, 6, 7]$ và $K = 3$:
