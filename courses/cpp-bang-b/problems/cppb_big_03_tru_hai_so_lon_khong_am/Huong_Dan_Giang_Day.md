# Hướng Dẫn Giảng Dạy: Trừ Hai Số Nguyên Lớn (A >= B)
...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: Trừ Hai Số Nguyên Lớn (A >= B).
...
* **Yêu cầu cốt lõi:** Cho 2 số nguyên dương lớn $A$ và $B$ ($A \ge B$). Hãy tính hiệu $A - B$.
