# Hướng Dẫn Giảng Dạy: Cái Túi Không Giới Hạn (Unbounded Knapsack)
...
- **Bản chất bài toán:** Cho $N$ loại phôi và tải trọng lò luyện $W$. Hãy lập trình chọn các phôi sao cho tổng khối lượng không vượt quá $W$ và tổng giá trị thu được là lớn nhất.
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `3 8 2 10 3 15 4 40` $\implies$ Đầu ra kỳ vọng: `80`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `3 8 2 10 3 15 4 40` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với tải trọng $W = 100$ và cho phép chọn không giới hạn số lượng mỗi loại: Ta có thể chọn lặp lại nhiều lần loại phôi có hiệu suất giá ... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `80` |

*Giải thích chi tiết:* Với tải trọng $W = 100$ và cho phép chọn không giới hạn số lượng mỗi loại:
