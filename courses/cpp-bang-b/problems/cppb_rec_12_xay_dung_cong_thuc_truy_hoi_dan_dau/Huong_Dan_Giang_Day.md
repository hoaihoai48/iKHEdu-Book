# Hướng Dẫn Giảng Dạy: Xây Dựng Hệ Thức Truy Hồi Cho Dãy Số Đan Dấu
Chuyên đề: **Bài 10: Thuật toán đệ quy & cây gọi hàm**

---

## 1. Ý tưởng & Phân tích thuật toán
- **Bản chất bài toán:** Cho số nguyên dương N. Hãy tính giá trị của biểu thức S(N) bằng đệ quy.
...
| 2 | Thực thi thuật toán tối ưu | S(5) = 1 - 2 + 3 - 4 + 5 = 3.... | Tính toán từng bước trạng thái |
| 3 | Xuất kết quả | Output: `3` | Khớp chính xác với đầu ra mẫu |

*Giải thích chi tiết từ mẫu:* S(5) = 1 - 2 + 3 - 4 + 5 = 3.
