...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật: Bài Toán Tháp Hà Nội (Tower of Hanoi).
...
* **Dữ liệu đầu vào:** - Một dòng duy nhất chứa số nguyên dương $N$ ($1 \le N \le 15$).
* **Yêu cầu cốt lõi:** Cho $N$ đĩa có kích thước từ $1$ đến $N$ đặt trên cọc $A$. Hãy in ra số bước di chuyển tối thiểu và các bước di chuyển từng đĩa từ cọc $A$ sang cọc $C$ dùng cọc $B$ làm trung gian theo quy tắc kinh điển.
...
A -> C
```
* **Phân tích thực thi:** Với N = 3 đĩa, cần đúng 2^3 - 1 = 7 bước.
