# Hướng Dẫn Giảng Dạy: Đoạn Con Có Tổng Lớn Nhất Trên Đoạn (Maximum Subarray Query)
...
- **Bản chất bài toán:** Cho mảng $A$ và $Q$ truy vấn gồm hai số $L, R$. Hãy tìm tổng lớn nhất của một đoạn con không rỗng nằm trọn vẹn bên trong đoạn $[L, R]$.
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `5 3 1 2 -5 4 5 2 1 5 1 3 10 2 1 5` $\implies$ Đầu ra kỳ vọng: `9 22`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `5 3 1 2 -5 4 5 2 1 5 1 3 10 2 1 5` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với mảng $[-2, 1, -3, 4, -1, 2, 1, -5, 4]$ và truy vấn đoạn từ vị trí 1 đến 9: Đoạn con liên tiếp có tổng lớn nhất là $[4, -1, 2, 1]$ m... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `9 22` |

*Giải thích chi tiết:* Với mảng $[-2, 1, -3, 4, -1, 2, 1, -5, 4]$ và truy vấn đoạn từ vị trí 1 đến 9:
