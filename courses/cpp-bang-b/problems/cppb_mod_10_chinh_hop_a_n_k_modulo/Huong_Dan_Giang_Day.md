...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: Tính Số Chỉnh Hợp A(N, K) mod M.
...
* **Yêu cầu cốt lõi:** Cho $Q$ truy vấn, mỗi truy vấn chứa 2 số $N, K$. Hãy tính số chỉnh hợp $A(N, K) = \frac{N!}{(N - K)!} \pmod{10^9 + 7}$.
