# Hướng Dẫn Giảng Dạy: Tính Số Chỉnh Hợp A(N, K) mod M
Chuyên đề: **Bài 08: Đồng dư thức, lũy thừa nhị phân & nghịch đảo modulo**

---

## 1. Ý tưởng & Phân tích thuật toán
- **Bản chất bài toán:** Cho Q truy vấn, mỗi truy vấn gồm 2 số N và K. Hãy tính số chỉnh hợp A(N, K) mod (10^9 + 7).
...
## 2. Bảng chạy tay trên số liệu mẫu (Dry Run Table - Sample 1: 2 5 2 4 3)
| Bước | Lệnh chạy / Thao tác | Phân tích biến đổi số liệu | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Nạp dữ liệu vào mảng/biến | Input: `2 5 2 4 3` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Thực thi thuật toán tối ưu | - A(5, 2) = 5 * 4 = 20. - A(4, 3) = 4 * 3 * 2 = 24.... | Tính toán từng bước trạng thái |
