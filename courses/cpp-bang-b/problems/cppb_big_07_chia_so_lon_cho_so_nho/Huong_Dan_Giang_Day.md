...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: Chia Số Lớn Cho Số Nhỏ (Lấy Thương).
...
* **Yêu cầu cốt lõi:** Cho số nguyên lớn $A$ và số nguyên nhỏ $b$ ($1 \le b \le 10^9$). Hãy tìm phần thương nguyên của phép chia $A / b$.
