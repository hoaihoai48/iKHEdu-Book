...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: Số Lớn Cực Hạn: Tổ Hợp C(N, K) Chính Xác.
...
* **Dữ liệu đầu vào:** - Một dòng duy nhất chứa 2 số nguyên $N, K$ ($0 \le K \le N \le 100$).
* **Yêu cầu cốt lõi:** Cho 2 số nguyên $N, K$. Hãy tính giá trị chính xác của $C(N, K) = \frac{N!}{K!(N-K)!}$ mà không lấy dư.
