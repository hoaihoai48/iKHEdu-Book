...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: Số Catalan Đồng Dư.
...
* **Dữ liệu đầu vào:** - Một dòng duy nhất chứa số nguyên $N$ ($0 \le N \le 10^6$).
* **Yêu cầu cốt lõi:** Số Catalan $C_N = \frac{1}{N + 1} C(2N, N)$. Cho số nguyên $N$, hãy tính $C_N \pmod{10^9 + 7}$.
