# Hướng Dẫn Giảng Dạy: Xóa Ít Ký Tự Nhất Để Chuỗi Đối Xứng
...
- **Bản chất bài toán:** Cho chuỗi ký tự $S$. Hãy lập trình tìm số lượng ký tự ít nhất cần xóa bỏ để chuỗi còn lại là một chuỗi đối xứng.
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `aebcbda` $\implies$ Đầu ra kỳ vọng: `2`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `aebcbda` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với chuỗi $S = \text{"aebcbda"}$: Chuỗi con đối xứng dài nhất có thể giữ lại là $\text{"abcba"}$ (độ dài 5). Để thu được chuỗi này, ta ... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `2` |

*Giải thích chi tiết:* Với chuỗi $S = \text{"aebcbda"}$:
