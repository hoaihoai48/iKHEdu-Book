...
## Bối cảnh
Cho 3 số nguyên $A, N, M$. Hãy tính tổng cấp số nhân $S(N) = A^0 + A^1 + A^2 + \dots + A^N \pmod M$ bằng kỹ thuật Chia Để Trị trong $\mathcal{O}(\log N)$ theo hệ thức $S(2k+1) = S(k) \times (1 + A^{k+1})$.
