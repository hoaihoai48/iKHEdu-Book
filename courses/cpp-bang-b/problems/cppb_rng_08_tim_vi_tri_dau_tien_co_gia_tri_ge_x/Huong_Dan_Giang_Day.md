# Hướng Dẫn Giảng Dạy: Tìm Vị Trí Đầu Tiên Có Giá Trị Lớn Hơn Hoặc Bằng X
...
- **Bản chất bài toán:** Cho mảng $A$ và $Q$ truy vấn gồm 3 số $L, R, X$. Hãy lập trình tìm vị trí chỉ số đầu tiên trong đoạn $[L, R]$ có giá trị $\ge X$.
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `5 3 1 3 2 4 5 2 1 5 3 1 2 1 2 1 5 3` $\implies$ Đầu ra kỳ vọng: `2 4`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `5 3 1 3 2 4 5 2 1 5 3 1 2 1 2 1 5 3` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với mảng $[2, 3, 5, 1, 6]$ và truy vấn trong khoảng $[1, 5]$ tìm số $\ge 4$: Đi từ vị trí 1 sang: vị trí 1 là 2 (< 4), vị trí 2 là 3 (<... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `2 4` |

*Giải thích chi tiết:* Với mảng $[2, 3, 5, 1, 6]$ và truy vấn trong khoảng $[1, 5]$ tìm số $\ge 4$:
