# Hướng Dẫn Giảng Dạy: Khoảng Cách Chỉnh Sửa (Edit Distance / Levenshtein)
...
- **Bản chất bài toán:** Cho hai chuỗi ký tự $S$ và $T$. Hãy lập trình tìm số lượng thao tác chỉnh sửa ít nhất để biến đổi chuỗi $S$ thành chuỗi $T$.
...
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `horse ros` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Để biến đổi chuỗi $S = \text{"kitten"}$ thành $T = \text{"sitting"}$: 1. Thay thế ký tự 'k' thành 's' $\to \text{"sitten"}$. 2. Thay th... | Cập nhật các biến / mảng trạng thái |
