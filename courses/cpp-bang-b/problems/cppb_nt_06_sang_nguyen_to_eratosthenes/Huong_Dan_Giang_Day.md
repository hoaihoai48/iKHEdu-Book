...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán số học: Sàng Nguyên Tố Eratosthenes.
...
* **Dữ liệu đầu vào:** - Một dòng duy nhất chứa số nguyên dương $N$ ($2 \le N \le 10^7$).
* **Yêu cầu cốt lõi:** Cho số nguyên dương $N$. Hãy in ra tất cả các số nguyên tố không vượt quá $N$ theo thứ tự tăng dần.
