# Hướng Dẫn Giảng Dạy: Chèn Ít Ký Tự Nhất Tạo Chuỗi Đối Xứng
...
- **Bản chất bài toán:** Cho chuỗi ký tự $S$. Hãy lập trình tìm số lượng ký tự ít nhất cần phải chèn thêm vào chuỗi $S$ để biến nó thành một chuỗi đối xứng.
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `zzazz` $\implies$ Đầu ra kỳ vọng: `0`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `zzazz` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với chuỗi $S = \text{"mbadm"}$: Để chuỗi trở thành đối xứng, ta có thể chèn thêm 2 ký tự 'd' và 'b' vào các vị trí thích hợp để tạo thà... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `0` |

*Giải thích chi tiết:* Với chuỗi $S = \text{"mbadm"}$:
