...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật: Sinh Tất Cả Tập Con Của Tập N Phần Tử.
...
* **Yêu cầu cốt lõi:** Cho tập hợp $S = \{1, 2, \dots, N\}$. Hãy sinh tất cả các tập con của $S$ (kể cả tập rỗng) theo thứ tự từ điển bằng thuật toán Quay Lui dạng Chọn / Bỏ qua.
...
1 2 3
```
* **Phân tích thực thi:** Tất cả 8 tập con của {1, 2, 3}.
...
* **Ghi chú phân tích:** Mô hình nhánh Chọn / Bỏ qua tại mỗi bước i.
