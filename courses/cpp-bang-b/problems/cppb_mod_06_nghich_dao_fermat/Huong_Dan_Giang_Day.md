...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: Nghịch Đảo Modulo Bằng Fermat Nhỏ.
...
* **Dữ liệu đầu vào:** - Một dòng duy nhất chứa số nguyên $A$ ($1 \le A < 10^9 + 7$).
* **Yêu cầu cốt lõi:** Cho số nguyên $A$ và số nguyên tố $M = 10^9 + 7$. Hãy tìm nghịch đảo modulo $A^{-1} \pmod M$ ($1 \le A < M$).
