...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán số học: Số Có Đúng 3 Ước Số.
...
* **Yêu cầu cốt lõi:** Cho số nguyên dương $N$. Hãy đếm số lượng số nguyên dương $\le N$ có đúng 3 ước số nguyên dương phân biệt.
...
* **Phân tích quá trình thực thi:**
  Các số có đúng 3 ước là bình phương của số nguyên tố: {4, 9, 25, 49} -> 4 số.
