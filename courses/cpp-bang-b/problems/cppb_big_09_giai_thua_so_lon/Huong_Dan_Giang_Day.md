...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: Tính Giai Thừa Số Lớn (N!).
...
* **Yêu cầu cốt lõi:** Cho số nguyên dương $N$. Hãy in ra giá trị chính xác của $N! = 1 \times 2 \times \dots \times N$.
