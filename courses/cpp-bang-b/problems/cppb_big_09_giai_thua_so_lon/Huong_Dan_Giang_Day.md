...
- **Bản chất bài toán:** Cho số nguyên dương N (1 <= N <= 1000). Hãy in ra giá trị chính xác của N!.
...
| 2 | Thực thi thuật toán tối ưu | 5! = 1 * 2 * 3 * 4 * 5 = 120.... | Tính toán từng bước trạng thái |
| 3 | Xuất kết quả | Output: `120` | Khớp chính xác với đầu ra mẫu |

*Giải thích chi tiết từ mẫu:* 5! = 1 * 2 * 3 * 4 * 5 = 120.
