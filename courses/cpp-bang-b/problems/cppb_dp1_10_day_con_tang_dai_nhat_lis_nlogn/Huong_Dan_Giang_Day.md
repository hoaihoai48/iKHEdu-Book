# Hướng Dẫn Giảng Dạy: Dãy Con Tăng Dài Nhất LIS O(N log N)
...
- **Bản chất bài toán:** Cho dãy $A$ gồm $N$ số nguyên với $N$ lên tới $10^5$. Hãy lập trình xác định độ dài của dãy con tăng nghiêm ngặt dài nhất.
...
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với dãy số $[5, 2, 7, 4, 3, 8]$: Dãy con tăng nghiêm ngặt dài nhất có thể chọn là $[2, 4, 8]$ (hoặc $[2, 3, 8]$, $[5, 7, 8]$). Độ dài d... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `3` |

*Giải thích chi tiết:* Với dãy số $[5, 2, 7, 4, 3, 8]$:
