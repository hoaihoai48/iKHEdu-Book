# Hướng Dẫn Giảng Dạy: Dãy Con Tăng Dài Nhất LIS O(N^2)
...
- **Bản chất bài toán:** Cho dãy số nguyên $A$ gồm $N$ phần tử. Hãy lập trình tìm độ dài lớn nhất của một dãy con tăng nghiêm ngặt (không nhất thiết phải là các phần tử liên tiếp trong dãy ban đầu).
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `6 10 20 10 30 20 50` $\implies$ Đầu ra kỳ vọng: `4`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `6 10 20 10 30 20 50` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với dãy số gồm 6 phần tử $[10, 20, 10, 30, 20, 50]$: Một dãy con tăng nghiêm ngặt dài nhất có thể chọn là $[10, 20, 30, 50]$ (tương ứng... | Cập nhật các biến / mảng trạng thái |
