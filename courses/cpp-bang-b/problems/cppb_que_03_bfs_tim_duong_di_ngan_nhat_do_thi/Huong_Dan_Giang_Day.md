# Hướng Dẫn Giảng Dạy: BFS Tìm Bước Đi Ngắn Nhất Đồ Thị
...
- **Bản chất bài toán:** Cho đồ thị $N$ đỉnh $M$ cạnh và hai đỉnh $S, D$. Hãy lập trình tìm số bước đi ngắn nhất từ $S$ tới $D$. Nếu không thể đến được, in ra `-1`.
...
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với mạng gồm 4 máy chủ kết nối theo chuỗi $1 - 2 - 3 - 4$ và một kênh tắt nối trực tiếp $1 - 3$: Để đi từ 1 tới 4, gói tin đi qua kênh ... | Cập nhật các biến / mảng trạng thái |
