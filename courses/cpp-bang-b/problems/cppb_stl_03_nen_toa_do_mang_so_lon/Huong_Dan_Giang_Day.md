# Hướng Dẫn Giảng Dạy: Nén Tọa Độ Mảng Số Lớn
...
- **Bản chất bài toán:** Cho mảng gồm $N$ số nguyên. Hãy lập trình thay thế mỗi phần tử trong mảng bằng thứ hạng nén của nó (bắt đầu từ 1 cho giá trị nhỏ nhất).
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `5 100 20000 50 20000 100` $\implies$ Đầu ra kỳ vọng: `1 2 0 2 1`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `5 100 20000 50 20000 100` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với mảng số ban đầu là $[100, 5, 100, 20, 5]$: Các giá trị phân biệt sau khi sắp xếp tăng dần là: $5 < 20 < 100$. - Giá trị 5 nhỏ nhất ... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `1 2 0 2 1` |

*Giải thích chi tiết:* Với mảng số ban đầu là $[100, 5, 100, 20, 5]$:
