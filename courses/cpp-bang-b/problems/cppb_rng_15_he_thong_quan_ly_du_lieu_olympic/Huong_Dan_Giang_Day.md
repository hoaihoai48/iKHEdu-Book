# Hướng Dẫn Giảng Dạy: Hệ Thống Quản Lý Dữ Liệu Olympic (Range Master)
...
- **Bản chất bài toán:** Cho mảng $A$ và $Q$ truy vấn đa năng. Hãy lập trình thực thi chính xác và in ra kết quả tương ứng cho từng yêu cầu truy vấn thông tin.
...
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Hệ thống cập nhật linh hoạt các phân đoạn dữ liệu lớn và trả về tổng điểm cũng như điểm cực trị chính xác cho ban giám khảo trong thời ... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `21 15` |

*Giải thích chi tiết:* Hệ thống cập nhật linh hoạt các phân đoạn dữ liệu lớn và trả về tổng điểm cũng như điểm cực trị chính xác cho ban giám khảo trong thời gian thực.
