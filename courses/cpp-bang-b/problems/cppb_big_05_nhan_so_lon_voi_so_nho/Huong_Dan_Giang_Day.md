...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: Nhân Số Lớn Với Số Nhỏ.
...
* **Yêu cầu cốt lõi:** Cho số nguyên lớn $A$ và số nguyên nhỏ $b$ ($0 \le b \le 10^9$). Hãy tính tích $A \times b$.
