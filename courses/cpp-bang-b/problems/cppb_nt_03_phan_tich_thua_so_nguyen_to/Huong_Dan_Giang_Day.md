...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán số học: Phân Tích Thừa Số Nguyên Tố.
...
* **Dữ liệu đầu vào:** - Một dòng duy nhất chứa số nguyên dương $N$ ($2 \le N \le 10^{12}$).
* **Yêu cầu cốt lõi:** Cho số nguyên dương $N$. Hãy phân tích $N$ thành tích các thừa số nguyên tố theo dạng $p_1^{a_1} \times p_2^{a_2} \dots$.
