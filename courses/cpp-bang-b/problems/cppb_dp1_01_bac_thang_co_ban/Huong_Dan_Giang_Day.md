# Hướng Dẫn Giảng Dạy: Bậc Thang Cơ Bản
...
- **Bản chất bài toán:** Cho số nguyên dương $N$ là số bậc của cầu thang. Hãy lập trình tính số cách bước hợp lệ để robot lên đến đỉnh bậc thứ $N$. Vì kết quả có thể rất lớn, hãy in ra phần dư của kết quả khi chia cho $10^9 + 7$.
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `3` $\implies$ Đầu ra kỳ vọng: `3`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `3` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với cầu thang có $N = 3$ bậc, robot có tất cả 3 trình tự bước đi hợp lệ để lên đến đỉnh: 1. Bước từng bậc một: $1 + 1 + 1 = 3$. 2. Bước... | Cập nhật các biến / mảng trạng thái |
