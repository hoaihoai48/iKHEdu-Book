...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật: In Dãy Số Đệ Quy 1..N và N..1.
...
* **Dữ liệu đầu vào:** - Một dòng duy nhất chứa số nguyên dương $N$ ($1 \le N \le 1000$).
* **Yêu cầu cốt lõi:** Cho số nguyên dương $N$. Hãy in ra 2 dòng:
...
4 3 2 1
```
* **Phân tích thực thi:** Dòng 1 in trong pha Unwinding (1..4), dòng 2 in trong pha Winding (4..1).
...
* **Ghi chú phân tích:** Winding (trước đệ quy) in N..1, Unwinding (sau đệ quy) in 1..N.
