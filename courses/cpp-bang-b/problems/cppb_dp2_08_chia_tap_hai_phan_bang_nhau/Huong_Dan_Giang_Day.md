# Hướng Dẫn Giảng Dạy: Chia Tập Thành Hai Phần Bằng Nhau (Partition Equal Subset Sum)
...
- **Bản chất bài toán:** Cho danh sách giá trị của $N$ thửa đất. Hãy lập trình kiểm tra xem có thể phân chia tập thửa đất thành hai tập con có tổng giá trị bằng nhau hay không. Nếu được in ra `YES`, ngược lại in ra `NO`.
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `4 1 5 11 5` $\implies$ Đầu ra kỳ vọng: `YES`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `4 1 5 11 5` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với tập hợp các số $[1, 5, 11, 5]$: Tổng của toàn bộ dãy số là $1 + 5 + 11 + 5 = 22$. Ta có thể chia thành hai tập con $\{1, 5, 5\}$ và... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `YES` |

*Giải thích chi tiết:* Với tập hợp các số $[1, 5, 11, 5]$:
