...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán số học: Phân Tích Giai Thừa Ra Thừa Số (Định Lý Legendre).
...
* **Dữ liệu đầu vào:** - Một dòng duy nhất chứa 2 số nguyên $N$ và $P$ ($1 \le N \le 10^{18}, 2 \le P \le 10^6$, $P$ là số nguyên tố).
* **Yêu cầu cốt lõi:** Cho số nguyên $N$ và số nguyên tố $P$. Hãy tìm số mũ lớn nhất $K$ sao cho $N!$ chia hết cho $P^K$.
