# Hướng Dẫn Giảng Dạy: Đếm Cặp Số Có Hiệu Bằng K
...
- **Bản chất bài toán:** Cho mảng $A$ gồm $N$ số nguyên và số nguyên $K$. Hãy lập trình đếm số lượng cặp $(i, j)$ có $i < j$ và $A_j - A_i = K$.
...
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `5 2 1 5 3 4 2` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với mảng $[1, 5, 3, 4, 2]$ và $K = 2$: Các cặp có hiệu bằng 2 là: - $A_2 - A_3 = 5 - 3 = 2$. - $A_3 - A_1 = 3 - 1 = 2$. - $A_4 - A_5 = ... | Cập nhật các biến / mảng trạng thái |
