# Hướng Dẫn Giảng Dạy: Đếm Số Ô Kề Cạnh Hợp Lệ (4 Hướng)
...
- **Bản chất bài toán:** Cho kích thước ma trận $N, M$ và tọa độ $(r, c)$. Hãy lập trình đếm số ô kề cạnh hợp lệ nằm trong ma trận.
