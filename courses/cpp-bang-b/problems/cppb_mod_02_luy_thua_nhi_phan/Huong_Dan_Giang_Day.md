# Hướng Dẫn Giảng Dạy: Lũy Thừa Nhị Phân Cơ Bản
...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: Lũy Thừa Nhị Phân Cơ Bản.
...
* **Dữ liệu đầu vào:** - Một dòng duy nhất chứa 3 số nguyên $A, B, M$ ($0 \le A \le 10^{18}, 0 \le B \le 10^{18}, 1 \le M \le 10^9 + 7$).
* **Yêu cầu cốt lõi:** Cho 3 số nguyên $A, B, M$. Hãy tính $A^B \pmod M$ bằng thuật toán Lũy thừa nhị phân $\mathcal{O}(\log B)$.
