...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán: Nhân Hai Số Nguyên Lớn.
...
* **Dữ liệu đầu vào:** - Dòng 1: Chuỗi ký tự số $A$ ($1 \le |A| \le 2000$).
- Dòng 2: Chuỗi ký tự số $B$ ($1 \le |B| \le 2000$).
* **Yêu cầu cốt lõi:** Cho 2 số nguyên lớn $A$ và $B$. Hãy tính tích $A \times B$.
