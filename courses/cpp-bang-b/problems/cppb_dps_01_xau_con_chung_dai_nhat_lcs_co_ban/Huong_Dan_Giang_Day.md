# Hướng Dẫn Giảng Dạy: Xâu Con Chung Dài Nhất Cơ Bản (LCS)
...
- **Bản chất bài toán:** Cho hai chuỗi ký tự $S$ và $T$. Hãy lập trình tìm độ dài của xâu con chung dài nhất của hai chuỗi đó.
...
## 2. Bảng chạy tay trên số liệu mẫuMẫu thử (Sample 1): Đầu vào: `AGGTAB GXTXAYB` $\implies$ Đầu ra kỳ vọng: `4`.

| Bước | Thao tác thực hiện | Dữ liệu biến đổi & Trạng thái | Kết quả ghi nhận |
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `AGGTAB GXTXAYB` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Với hai xâu $S = \text{"ABCBDAB"}$ và $T = \text{"BDCAB"}$: Xâu con chung dài nhất có thể tìm được là $\text{"BCAB"}$ (hoặc $\text{"BDA... | Cập nhật các biến / mảng trạng thái |
