...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật: Đếm & Tính Tổng Chữ Số Của N Bằng Đệ Quy.
...
* **Yêu cầu cốt lõi:** Cho số nguyên dương $N$. Hãy viết hàm đệ quy để đếm số lượng chữ số và tính tổng tất cả các chữ số của $N$.
...
5 15
```
* **Phân tích thực thi:** 12345 có 5 chữ số, tổng = 1 + 2 + 3 + 4 + 5 = 15.
