# Hướng Dẫn Giảng Dạy: Nước Tràn Mê Cung (Multi-Source BFS)
...
- **Bản chất bài toán:** Cho bản đồ hầm mỏ và vị trí các nguồn nước ban đầu. Hãy lập trình tính thời gian (phút) để nước tràn kín toàn bộ các buồng trống liên thông.
...
|---|---|---|---|
| 1 | Khởi tạo & Đọc dữ liệu | Nạp Input: `3 3 W.. .## ..E` | Khởi tạo cấu trúc dữ liệu ban đầu |
| 2 | Chạy thuật toán từng bước | Phân tích mẫu: Nước bắt đầu loang đồng thời từ các điểm 'W' theo chiều rộng: Sau đúng 4 phút, điểm buồng mỏ xa nhất đã bị nước tràn tới ngập hoàn toàn... | Cập nhật các biến / mảng trạng thái |
| 3 | Xuất kết quả chuẩn | Đối chiếu trạng thái cuối cùng | Output chuẩn: `4` |

*Giải thích chi tiết:* Nước bắt đầu loang đồng thời từ các điểm 'W' theo chiều rộng:
