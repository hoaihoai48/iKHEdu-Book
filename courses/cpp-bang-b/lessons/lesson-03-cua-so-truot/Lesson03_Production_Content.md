...
* D. Mảng 2 chiều kích thước $N \times N$.
...
> *Giải thích:* Quy tắc trượt cửa sổ cố định: $\text{sum} = \text{sum} - A[i-K] + A[i]$ chỉ mất $\mathcal{O}(1)$ thời gian.
...
> *Giải thích:* $R$ duyệt từ $0 \to N-1$ ($N$ bước) và $L$ duyệt từ $0 \to N$ (tối đa $N$ bước). Tổng số bước di chuyển của cả 2 con trỏ không bao giờ vượt quá $2N$.
...
* A. Khi tổng cửa sổ $\text{current\_sum} \le S$.
* B. **(Đáp án đúng)** Khi tổng cửa sổ $\text{current\_sum} > S$ (cửa sổ vi phạm điều kiện, cần co $L$ cho đến khi tổng $\le S$ trở lại).
* C. Khi con trỏ $R$ chạm đến cuối mảng.
* D. Sau mỗi lần tăng con trỏ $R$.
> *Giải thích:* Với bài toán tìm $\max$ độ dài thỏa mãn $\text{sum} \le S$, ta chỉ co $L$ khi tổng đang bị vượt quá ngưỡng cho phép ($> S$) để đưa cửa sổ về trạng thái hợp lệ.
...
> *Giải thích:* Tổng của $10^5$ phần tử có giá trị $10^9$ là $10^5 \times 10^9 = 10^{14}$, vượt xa giới hạn khoảng $2.14 \times 10^9$ của kiểu `int` 32-bit.

---

#### Câu 10 (Kỹ thuật hiệu đếm đoạn con — Interval Counting Trick):
Để đếm số lượng đoạn con liên tiếp có tổng nằm trong khoảng $[A, B]$ (tức $A \le \text{sum} \le B$) trên mảng số nguyên dương, kỹ thuật chuẩn mực là gì?
...
* C. Sử dụng cây Segment Tree với độ phức tạp $\mathcal{O}(N \log^2 N)$.
