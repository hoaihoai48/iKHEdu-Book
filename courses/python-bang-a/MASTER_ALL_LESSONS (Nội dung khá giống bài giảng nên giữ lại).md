...
### Chương 1: NỀN TẢNG PYTHON & TÍNH TOÁN CƠ BẢN
- Bài 01: lesson-01
- Bài 02: lesson-02
- Bài 03: lesson-03
...
- Bài 05: lesson-05
- Bài 06: lesson-06
### Chương 3: VÒNG LẶP & CÁC BÀI TOÁN DÃY SỐ
- Bài 07: lesson-07
- Bài 08: lesson-08
- Bài 09: lesson-09
### Chương 4: SỐ HỌC CƠ BẢN & TÁCH CHỮ SỐ
- Bài 10: lesson-10
- Bài 11: lesson-11
- Bài 12: lesson-12
### Chương 5: THẾ GIỚI CHUỖI KÝ TỰ
- Bài 13: lesson-13
- Bài 14: lesson-14
- Bài 15: lesson-15
### Chương 6: DANH SÁCH (LIST) & LUYỆN ĐỀ THTA
- Bài 16: lesson-16
- Bài 17: lesson-17
- Bài 18: lesson-18
...
| 04 | Bài 01–03 | So sánh, Boolean, `if/else` | Decision: điều kiện → kết quả | Cơ bản đến vận dụng | Viết được một nhánh điều kiện đúng |
| 05 | Bài 04 | `elif`, nhiều trường hợp | Classification | Cơ bản đến vận dụng | Phân loại dữ liệu theo thứ tự điều kiện |
| 06 | Bài 04–05 | `and`, `or`, `not`, điều kiện ghép | Boolean expression | Cơ bản đến thử thách | Kiểm tra đồng thời nhiều điều kiện |
| 07 | Bài 02 | `for`, `range` | Sum / accumulator | Cơ bản đến thử thách | Duyệt một khoảng và tích lũy kết quả |
| 08 | Bài 04, 07 | `while`, `break`, `continue` | Sentinel / flag | Cơ bản đến vận dụng | Điều khiển vòng lặp chưa biết trước số lượt |
| 09 | Bài 07–08 | Dãy số, Fibonacci, nested loop | Rolling variables / pattern | Bắt buộc và thử thách | Sinh dãy và in mẫu bằng vòng lặp |
| 10 | Bài 02, 08 | Tách chữ số bằng `// 10`, `% 10` | Digit extraction | Bắt buộc và thử thách | Xử lý từng chữ số của số nguyên |
| 11 | Bài 02, 07 | Ước, bội, nguyên tố, GCD | Divisor scan | Bắt buộc và thử thách | Kiểm tra và đếm tính chất số học |
| 12 | Bài 10–11 | Số đặc biệt và đếm theo đoạn | Predicate + counting | Bắt buộc và thử thách | Đếm phần tử thỏa điều kiện |
| 13 | Bài 01 | Index, slice, chuỗi là sequence | Sequence access | Cơ bản đến vận dụng | Lấy và cắt đúng phần chuỗi |
| 14 | Bài 13 | Duyệt và biến đổi ký tự | String traversal / counting | Cơ bản đến vận dụng | Duyệt chuỗi theo ký tự hoặc vị trí |
| 15 | Bài 13–14 | `split`, `join`, `ord`, `chr` | Tokenize → transform → join | Cơ bản đến vận dụng | Biến đổi chuỗi theo quy tắc |
| 16 | Bài 07, 14 | List, index, mutable, thao tác cơ bản | List traversal | Cơ bản đến vận dụng | Duyệt và cập nhật danh sách |
| 17 | Bài 16 | Thống kê, sắp xếp, trùng lặp | Statistics / ordering | Bắt buộc và thử thách | Tóm tắt và sắp xếp dữ liệu |
| 18 | Bài 01–17 | Đọc đề, test biên, chiến lược thi | Pattern selection | 3 đề tổng hợp | Chọn mô hình giải và tự kiểm thử |
...
================================================================================
# CHƯƠNG 01: NỀN TẢNG PYTHON & TÍNH TOÁN CƠ BẢN
================================================================================
...
* Khi đi thi Lập trình Python, đề bài thường yêu cầu đọc dữ liệu trên từng dòng hoặc cùng dòng, học sinh Phổ thông nắm chắc `int(input())` là đã giải quyết được hơn 80% các bài toán mở màn!
...
Đây là **vũ khí quan trọng nhất** trong các kỳ thi Lập trình Python Phổ thông! Hãy cùng giải mã từng phép toán:
...
> 🌟 **Công thức vàng của toán học Phổ thông được tái hiện trong Python:**
...
## 4. Bốn ứng dụng kỳ diệu của phép chia dư `%` trong đề thi Lập trình Python

Tại sao các đề thi Python Bảng A lại xuất hiện phép `%` nhiều đến thế? Bởi vì nó giải quyết được 4 bài toán kinh điển:
...
Cũng giống như môn Toán ở trường Phổ thông, máy tính tuân thủ quy tắc ưu tiên nghiêm ngặt từ trái sang phải:
...
Trong các kỳ thi Python Bảng A, có một mảng đề thi vô cùng quen thuộc và chiếm tỷ lệ điểm rất cao: **Các bài toán hình học và bài toán thực tế đời thường** (chu vi, diện tích hình chữ nhật, hình vuông, tam giác, bài toán hồ nước bao quanh đảo, bài toán đồng hồ thời gian).
...
1. Chuyển đổi chính xác các công thức hình học Phổ thông thành các dòng code Python an toàn.
...
Hãy cùng ôn lại các công thức toán Phổ thông và cách viết code tương ứng:
...
Một dạng bài rất hay gặp trong đề thi Lập trình Python (như *Bài 2: Hồ cá sấu - PYA Lâm Đồng*):
...
### 3.2. Bài toán Mario cứu công chúa (bài 3 PYA củ chi)
...
| 06 | `PYA-L05-P06` | Mario cứu công chúa | `Luyện tập` | $1 \le K, P, N \le 1000$ | Mô phỏng di chuyển năng lượng (PYA củ chi) |
...
| 09 | `PYA-L05-P09` | Thuận đi tìm ánh đa vận tốc | `Luyện tập` | $0 \le x, y \le 10^9, v \ge 0$ | Bắt bẫy $x == y$ hoặc $v == 0$ (PYA từ sơn) |
| 10 | `PYA-L05-P10` | Thứ mấy trong tuần? | `Luyện tập` | $1 \le k \le 365$ | Đổi số ngày sang thứ hai đến chủ nhật |
| 11 | `PYA-L05-P11` | Cửa hàng bánh bột lọc khuyến mãi | `Luyện tập` | $1 \le N \le 1000$ | Bài toán mua theo gói bậc thang (PYA Bảng A) |
...
## 3. Hai bài toán "vàng" kinh điển trong các đề thi Lập trình Python
...
```
Cú pháp này cực kỳ trực quan và tự nhiên cho các bạn học sinh Phổ thông!
...
| 07 | `PYA-L06-P07` | Số ngày trong tháng | `Luyện tập` | $1 \le M \le 12, 1 \le Y \le 10^5$ | Xác định 28, 29, 30 hay 31 ngày (PYA bắc giang) |
...
================================================================================
# CHƯƠNG 03: VÒNG LẶP & CÁC BÀI TOÁN DÃY SỐ
================================================================================
...
Đây là mẫu bài toán kinh điển nhất trong lập trình Phổ thông: **Tính tổng $S = 1 + 2 + 3 + \dots + N$**.
...
* Đọc dữ liệu từ bàn phím: Người dùng nhập các số liên tục **CHO ĐẾN KHI NHẬP SỐ 0 THÌ DỪNG** (như *Bài 6 Đề thi PYA Đà Lạt*).
...
Trong các đề thi Python Bảng A và kỳ thi Toán Tuổi thơ, bài toán về **Dãy số có quy luật** luôn là phần thi hấp dẫn và kích thích trí tuệ nhất!
...
Khi viết đề thi Lập trình Python, dạng bài **Vẽ tam giác số / tháp số** xuất hiện với tần suất cực kỳ cao.
...
================================================================================
# CHƯƠNG 04: SỐ HỌC CƠ BẢN & TÁCH CHỮ SỐ
================================================================================
...
Trong các bài toán số học của Python Bảng A, việc làm việc với từng chữ số của một số tự nhiên là một dạng bài thường gặp, ví dụ:
...
# Hệ thống bài tập thực hành — bài 10: Tách chữ số với chia nguyên và chia dư
...
### 2.2. Thuật toán duyệt tìm ước cơ bản (dành cho phổ thông)
...
* **Bài toán đếm số trong đoạn $[A, B]$:** Trong các đề thi Lập trình Python, các câu hỏi như: *"Trong đoạn từ $A$ đến $B$, có bao nhiêu số chia hết cho 3 nhưng không chia hết cho 5?"* luôn là "mỏ điểm" quý giá nếu em nắm vững kỹ thuật đếm!
...
================================================================================
# CHƯƠNG 05: THẾ GIỚI CHUỖI KÝ TỰ
================================================================================
...
================================================================================
# CHƯƠNG 06: DANH SÁCH (LIST) & LUYỆN ĐỀ THTA
================================================================================
...
Trong các đề thi Lập trình Python, đề bài thường cho: *"Dòng thứ hai chứa $N$ số nguyên cách nhau bởi khoảng trắng"*.
...
# Hệ thống bài tập thực hành — bài 16: Danh sách và thao tác cơ bản
...
Đây là một trong những vũ khí quan trọng nhất khi đi thi Lập trình Python!
...
# Hệ thống bài tập thực hành — bài 17: Thống kê danh sách và sắp xếp
...
# Bài 18: Chiến lược giải đề Python Bảng A

---

## 1. Khởi động: Bước vào đấu trường Python Bảng A
...
Bài học cuối cùng này sẽ trang bị cho các em cẩm nang tác chiến thực thụ của các Quán quân Lập trình Python toàn quốc.

---

## 2. Bản đồ tác chiến 5 bước trong phòng thi Lập trình Python
...
## 3. Cấu trúc một đề thi chuẩn Python Bảng A phổ thông

Một đề thi Python Bảng A thường gồm nhiều bài toán với mức độ tăng dần. Cấu trúc cụ thể phụ thuộc vào kỳ thi và ban tổ chức:
...
# Hệ thống bài tập thực hành — bài 18: Chiến lược giải đề Python Bảng A
