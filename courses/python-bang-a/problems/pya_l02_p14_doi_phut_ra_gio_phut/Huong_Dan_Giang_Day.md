...
* **Chuẩn code chuẩn:** Đọc 1 số, in 2 số trên một dòng cách nhau dấu cách.
...
3. Nếu dùng phép `/` thì kết quả in ra thế nào? Vì sao chương trình kiểm tra lại bắt lỗi?
...
2. **In mỗi số một dòng:** Đề yêu cầu in trên một dòng `2 15`, in 2 dòng bị `kết quả sai`.
