...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Tổng Các Số Tự Nhiên** (`PYA-L07-P03`) bằng Python.
...
```python
# Gợi ý mã nguồn cho PYA-L07-P03: Tổng Các Số Tự Nhiên
