...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Xe Buýt Chở Học Sinh** (`PYA-L02-P11`) bằng Python.
...
3
```
* **Giải thích:** 2 xe đầu chở được 20 bạn, còn 5 bạn nữa bắt buộc phải thuê thêm 1 xe thứ ba.
...
```python
# Gợi ý mã nguồn cho PYA-L02-P11: Xe Buýt Chở Học Sinh
