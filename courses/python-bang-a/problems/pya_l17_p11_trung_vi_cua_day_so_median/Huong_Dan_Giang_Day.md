...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Trung Vị Của Dãy Số (Median)** (`PYA-L17-P11`) bằng Python.
...
6
```
* **Giải thích:** Sắp xếp: [2, 4, 6, 8, 10]. Số chính giữa là 6.
