...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Đếm Chữ Số Chẵn Và Lẻ** (`PYA-L10-P06`) bằng Python.
...
2 2
```
* **Giải thích:** Chữ số chẵn: 2, 0 (2 số). Chữ số lẻ: 3, 5 (2 số).
