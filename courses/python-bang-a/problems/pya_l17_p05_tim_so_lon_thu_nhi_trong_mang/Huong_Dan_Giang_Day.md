...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Tìm Số Lớn Thứ Nhì Trong Mảng** (`PYA-L17-P05`) bằng Python.
...
15
```
* **Giải thích:** Số lớn nhất là 20. Số lớn thứ hai nhỏ hơn 20 là 15.
