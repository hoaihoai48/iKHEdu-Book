...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Ước Chung Lớn Nhất & BCNN** (`PYA-L11-P06`) bằng Python.
...
6 36
```
* **Giải thích:** $\text{GCD}(12, 18) = 6$, $\text{LCM}(12, 18) = (12 \times 18) // 6 = 36$.
