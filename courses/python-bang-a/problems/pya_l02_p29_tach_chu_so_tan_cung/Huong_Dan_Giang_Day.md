...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Tách Chữ Số Tận Cùng** (`PYA-L02-P09`) bằng Python.
...
```python
# Gợi ý mã nguồn cho PYA-L02-P09: Tách Chữ Số Tận Cùng
