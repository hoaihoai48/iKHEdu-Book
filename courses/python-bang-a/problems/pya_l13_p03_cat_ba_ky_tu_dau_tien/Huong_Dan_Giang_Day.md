...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Cắt Ba Ký Tự Đầu Tiên** (`PYA-L13-P03`) bằng Python.
...
```python
# Gợi ý mã nguồn cho PYA-L13-P03: Cắt Ba Ký Tự Đầu Tiên
