# Hướng Dẫn Giảng Dạy: Đếm Số Chính Phương Trong Đoạn
Chuyên đề: **Đếm Số Theo Quy Luật & Các Con Số Đặc Biệt**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Đếm Số Chính Phương Trong Đoạn** (`PYA-L12-P11`) bằng Python.
...
3
```
* **Giải thích:** Có 3 số chính phương là 9, 16, 25.
...
```python
# Gợi ý mã nguồn cho PYA-L12-P11: Đếm Số Chính Phương Trong Đoạn
