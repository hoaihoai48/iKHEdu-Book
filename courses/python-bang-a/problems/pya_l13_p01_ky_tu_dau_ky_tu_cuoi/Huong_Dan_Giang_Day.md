...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Ký Tự Đầu & Ký Tự Cuối** (`PYA-L13-P01`) bằng Python.
...
```python
# Gợi ý mã nguồn cho PYA-L13-P01: Ký Tự Đầu & Ký Tự Cuối
