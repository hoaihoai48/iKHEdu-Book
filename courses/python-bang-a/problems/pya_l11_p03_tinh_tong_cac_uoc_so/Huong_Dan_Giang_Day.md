...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Tính Tổng Các Ước Số** (`PYA-L11-P03`) bằng Python.
...
12
```
* **Giải thích:** Các ước là 1, 2, 3, 6 $\implies 1 + 2 + 3 + 6 = 12$.
...
```python
# Gợi ý mã nguồn cho PYA-L11-P03: Tính Tổng Các Ước Số
