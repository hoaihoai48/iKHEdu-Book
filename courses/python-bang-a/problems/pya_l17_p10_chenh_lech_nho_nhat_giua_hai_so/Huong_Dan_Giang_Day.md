...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Chênh Lệch Nhỏ Nhất Giữa Hai Số** (`PYA-L17-P10`) bằng Python.
...
2
```
* **Giải thích:** Sắp xếp: [1, 8, 10, 15]. Chênh lệch giữa 8 và 10 là $
