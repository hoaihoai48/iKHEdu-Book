...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Nén Chuỗi Ký Tự (Run-Length Encoding)** (`PYA-L14-P11`) bằng Python.
...
```python
# Gợi ý mã nguồn cho PYA-L14-P11: Nén Chuỗi Ký Tự (Run-Length Encoding)
