...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Tổng Chữ Số Của Số 3 Chữ Số** (`PYA-L10-P02`) bằng Python.
...
```python
# Gợi ý mã nguồn cho PYA-L10-P02: Tổng Chữ Số Của Số 3 Chữ Số
