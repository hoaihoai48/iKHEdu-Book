...
for ch in s:
    ...
    print(dem)
```
Với mẫu trên in ra 9 dòng `1, 1, 2, 2, 3...`, đáp án đúng chỉ là một dòng `5`. Cách sửa: đưa `print(dem)` ra ngoài vòng lặp.
