...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Đếm Số Lượng Nguyên Âm** (`PYA-L14-P10`) bằng Python.
...
5
```
* **Giải thích:** Các nguyên âm: E, U, A, I, O (có 5 nguyên âm).
...
```python
# Gợi ý mã nguồn cho PYA-L14-P10: Đếm Số Lượng Nguyên Âm
