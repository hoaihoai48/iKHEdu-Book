...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Đếm Số Lẻ Trong Đoạn** (`PYA-L12-P02`) bằng Python.
...
3
```
* **Giải thích:** Có 3 số lẻ là: 3, 5, 7.
...
```python
# Gợi ý mã nguồn cho PYA-L12-P02: Đếm Số Lẻ Trong Đoạn
