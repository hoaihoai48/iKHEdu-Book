...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Đếm Chữ Cái In Hoa & In Thường** (`PYA-L14-P04`) bằng Python.
...
3 11
```
* **Giải thích:** Chữ in hoa: 'L', 'T', 'P' (3 chữ).
