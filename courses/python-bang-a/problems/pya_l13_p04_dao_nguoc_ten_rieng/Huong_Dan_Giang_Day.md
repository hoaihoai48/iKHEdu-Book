...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Đảo Ngược Tên Riêng** (`PYA-L13-P04`) bằng Python.
...
```python
# Gợi ý mã nguồn cho PYA-L13-P04: Đảo Ngược Tên Riêng
