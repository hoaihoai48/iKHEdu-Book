...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Thứ Mấy Trong Tuần?** (`PYA-L05-P10`) bằng Python.
...
20
```
* **Giải thích:** Chạy thử nghiệm mẫu cho bài toán Thứ Mấy Trong Tuần?.
