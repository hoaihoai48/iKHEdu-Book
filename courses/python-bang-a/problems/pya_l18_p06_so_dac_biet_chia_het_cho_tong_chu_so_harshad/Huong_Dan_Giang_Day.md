# Hướng Dẫn Giảng Dạy: Số Đặc Biệt Chia Hết Cho Tổng Chữ Số (Harshad Number)
Chuyên đề: **Chiến Lược Giải Đề Thi Tin Học Trẻ Bảng A**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Số Đặc Biệt Chia Hết Cho Tổng Chữ Số (Harshad Number)** (`PYA-L18-P06`) bằng Python.
...
```python
# Gợi ý mã nguồn cho PYA-L18-P06: Số Đặc Biệt Chia Hết Cho Tổng Chữ Số (Harshad Number)
