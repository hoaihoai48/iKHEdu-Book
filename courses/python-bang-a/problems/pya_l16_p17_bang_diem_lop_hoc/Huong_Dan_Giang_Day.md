# Hướng Dẫn Giảng Dạy — Bảng Điểm Lớp Học (`PYA-L16-P03`)

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)

- Học sinh giải được bài ở mức Dễ trong 90 phút thi thử.
- Rèn pattern ẩn: **list (max / min / trung bình)**.
- Mục tiêu trong ma trận Bai_Tap.md: Rèn đọc danh sách và thống kê cơ bản.
...
- Trường hợp biên: N = 1 (max = min = trung bình); mọi điểm bằng nhau.
...
- Bất biến: max, min và tổng chỉ cần một lượt duyệt danh sách.
...
- 8 7 10 6 9: max 10, min 6, tổng 40, trung bình 8.0.
...
- In trung bình thiếu đúng 1 chữ số thập phân; quên chuyển input thành số.
