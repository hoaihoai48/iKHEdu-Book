...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Tổng Tích Hai Số Liền Nhau** (`PYA-L09-P06`) bằng Python.
...
20
```
* **Giải thích:** $1 \times 2 + 2 \times 3 + 3 \times 4 = 2 + 6 + 12 = 20$.
