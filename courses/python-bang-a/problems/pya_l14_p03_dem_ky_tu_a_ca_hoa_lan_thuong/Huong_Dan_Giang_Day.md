# Hướng Dẫn Giảng Dạy: Đếm Ký Tự 'A' (Cả Hoa Lẫn Thường)
Chuyên đề: **Duyệt Chuỗi & Biến Đổi Ký Tự Thần Kỳ**

---

## 1. Mục Tiêu Học Tập & Chuẩn Đầu Ra (Learning Objectives)
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Đếm Ký Tự 'A' (Cả Hoa Lẫn Thường)** (`PYA-L14-P03`) bằng Python.
...
4
```
* **Giải thích:** Gồm chữ 'A' (1 lần) và 'a' (3 lần trong 'va', 'Ba', 'bai').
