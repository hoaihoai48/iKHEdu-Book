...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Xóa Ký Tự Ở Vị Trí K** (`PYA-L13-P10`) bằng Python.
...
PYHON
```
* **Giải thích:** Xóa ký tự tại index 2 là chữ 'T'.
