...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Rút Trích Tên Miền Email** (`PYA-L13-P07`) bằng Python.
...
```python
# Gợi ý mã nguồn cho PYA-L13-P07: Rút Trích Tên Miền Email
