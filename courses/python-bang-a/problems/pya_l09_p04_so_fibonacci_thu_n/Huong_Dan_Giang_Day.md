...
* **Kỹ năng cốt lõi:** Nắm vững và làm chủ kỹ thuật giải quyết bài toán **Số Fibonacci Thứ N** (`PYA-L09-P04`) bằng Python.
...
8
```
* **Giải thích:** Dãy là 1, 1, 2, 3, 5, 8. Số thứ 6 là 8.
